function serial_benders_train(;
    ...
    while true
        ...
        treat_termination_status(first_stage_model, t, 0, policy_training_options.log_error_dir)
        ...
        for s in 1:policy_training_options.num_scenarios
            ...
            treat_termination_status(second_stage_model, t, s, policy_training_options.log_error_dir)
